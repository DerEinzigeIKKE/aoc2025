...
def main():
    ...
    while (i != 1):
        i = 1
        adder, matrice = select_place(data)
        reset_matrice(matrice)
        sum += adder
        i += adder
